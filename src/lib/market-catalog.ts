...
function series(base: number, drift = 0.04): number[] {
  // 8 点温和上行兜底曲线（仅 API 不可用时用于教学展示；真实日线在线时整段覆盖）。
  const out: number[] = [];
  for (let i = 7; i >= 0; i--) {
    out.push(Number((base * (1 - (i * drift) / 7)).toFixed(base >= 100 ? 2 : 3)));
  }
  return out;
}
...
export const CN_INSTRUMENTS: CatalogInstrument[] = [
  {
    ...
    teachingNote: "适合理解「强品牌护城河 + 高估值」如何共存，是练耐心而非追涨的样本。",
    observationAngle: "重点看高端消费需求、批价走势与估值容忍度之间的配合。",
    aiRelevance: 24, sectorHeat: 72, fallbackPrice: 1212.1, fallbackChange: 0.42, fallbackSeries: series(1212.1),
  },
  {
    ...
    aiRelevance: 38, sectorHeat: 80, fallbackPrice: 401.9, fallbackChange: 1.12, fallbackSeries: series(401.9, 0.06),
  },
  {
    ...
    aiRelevance: 28, sectorHeat: 58, fallbackPrice: 49.3, fallbackChange: -0.36, fallbackSeries: series(49.3, 0.03),
  },
  {
    ...
    aiRelevance: 22, sectorHeat: 54, fallbackPrice: 36.23, fallbackChange: 0.28, fallbackSeries: series(36.23, 0.025),
  },
  {
    ...
    aiRelevance: 22, sectorHeat: 66, fallbackPrice: 75, fallbackChange: 0.55, fallbackSeries: series(75, 0.04),
  },
  {
    ...
    teachingNote: "适合观察制造业龙头如何用规模与成本打仗，叙事强但要盯真实交付。",
    observationAngle: "重点看月度销量、海外扩张与单车利润的平衡。",
    aiRelevance: 34, sectorHeat: 78, fallbackPrice: 82.2, fallbackChange: -0.74, fallbackSeries: series(82.2, 0.05),
  },
  {
...
export const HK_INSTRUMENTS: CatalogInstrument[] = [
  {
    ...
    aiRelevance: 84, sectorHeat: 86, fallbackPrice: 421.4, fallbackChange: 1.04, fallbackSeries: series(421.4, 0.04),
  },
  {
    ...
    aiRelevance: 80, sectorHeat: 82, fallbackPrice: 95, fallbackChange: 1.86, fallbackSeries: series(95, 0.05),
  },
  {
    ...
    aiRelevance: 40, sectorHeat: 74, fallbackPrice: 66.1, fallbackChange: -1.1, fallbackSeries: series(66.1, 0.05),
  },
  {
    ...
    aiRelevance: 48, sectorHeat: 76, fallbackPrice: 22.3, fallbackChange: 2.05, fallbackSeries: series(22.3, 0.06),
  },
  {
    ...
    aiRelevance: 30, sectorHeat: 52, fallbackPrice: 77.65, fallbackChange: 0.32, fallbackSeries: series(77.65, 0.02),
  },
  {
...
export const FUND_INSTRUMENTS: CatalogInstrument[] = [
  {
    ...
    aiRelevance: 30, sectorHeat: 62, fallbackPrice: 5.048, fallbackChange: 0.36, fallbackSeries: series(5.048, 0.02),
  },
  {
    ...
    aiRelevance: 32, sectorHeat: 60, fallbackPrice: 9.085, fallbackChange: 0.62, fallbackSeries: series(9.085, 0.03),
  },
  {
    ...
    aiRelevance: 56, sectorHeat: 70, fallbackPrice: 2.178, fallbackChange: 1.28, fallbackSeries: series(2.178, 0.05),
  },
  {
    ...
    aiRelevance: 44, sectorHeat: 64, fallbackPrice: 4.395, fallbackChange: 0.91, fallbackSeries: series(4.395, 0.04),
  },
  {
    ...
    aiRelevance: 72, sectorHeat: 78, fallbackPrice: 2.208, fallbackChange: 0.45, fallbackSeries: series(2.208, 0.03),
  },
  {
    ...
    summary: "SPY 跟踪标普500，是全球最具代表性的宽基 ETF，常被当作「买入美国大盘」的默认选择。",
    teachingNote: "适合作为全球资产配置的锚：先理解宽基长期回报，再谈主动选择。",
    observationAngle: "重点看美国宏观、企业盈利与利率路径对大盘的整体影响。",
    aiRelevance: 60, sectorHeat: 72, fallbackPrice: 733.24, fallbackChange: 0.31, fallbackSeries: series(733.24, 0.02),
  },
  {
